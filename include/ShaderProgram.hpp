...
public:
    ...
    {
        //this->use();
        glUniformMatrix4fv(this->uniform(name), 1, GL_FALSE, glm::value_ptr(matrix));
        //this->disable();
    }
    ...
    {
        //this->use();
        glUniform3f(this->uniform(name), value.x, value.y, value.z);
        //this->disable();
    }
    ...
    void setUniformBlock(const GLchar *name, const GLuint bind_point)
    {
        glUniformBlockBinding(programId, glGetUniformBlockIndex(programId, name), bind_point);
    }
